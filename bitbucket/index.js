...
var BitBucket = (function(){
   ...
   * @return {BitBucket}        fluent interface
   */
  BitBucket.prototype.authenticateOAuth = function(oauth, accessToken, accessTokenSecret)
  {
    this.getRequest()
   ...
   * @returns {Request}
   */
  BitBucket.prototype.get = function(route, parameters, requestOptions, callback) {
   ...
   * @returns {Request}
   */
  BitBucket.prototype["delete"] = function(route, parameters, requestOptions, callback) {
   ...
   * @returns {Request}
   */
  BitBucket.prototype.post = function(route, parameters, requestOptions, callback) {
