...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            if ($model->save()) {
                ...
                Yii::$app->session->setFlash('error', 'There was a problem with your request.');
                Yii::$app->log('error',$model->getErrors());
            }
    ...
    private function getFitbitRedirectUri()
    {
        return "http://".$_SERVER['HTTP_HOST']."/fitbit";
    }
    
    public function actionSleepreport()
    {
        return $this->render('sleepreport');
    }
